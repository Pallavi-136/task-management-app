...
"[project]/app/config.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/alltasks/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/config.js [app-ssr] (ecmascript)");
...
function AllTasksPage() {
    ...
    const fetchTasks = async ()=>{
        ...
        if (!token) return;
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]}/api/tasks`, {
            headers: {
    ...
    const markDone = async (id)=>{
        const token = localStorage.getItem("token");
        await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]}/api/tasks/${id}`, {
            method: "PUT",
            headers: {
    ...
    const editTask = async (task)=>{
        ...
        if (!newTitle) return;
        const token = localStorage.getItem("token");
        await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$config$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]}/api/tasks/${task._id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4831960c._.js.map