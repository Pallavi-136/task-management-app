...
function CreateTaskPage() {
    ...
    const handleCreate = async (e)=>{
        ...
        try {
            ...
            if (res.ok) {
                router.push("/alltasks"); // Redirect to All Tasks after creating
            } else {
    ...
    if (!token) {
        if ("TURBOPACK compile-time truthy", 1) router.push("/login");
        return null;
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "tasks-background flex justify-center items-center min-h-screen",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
            onSubmit: handleCreate,
            className: "card w-full max-w-lg p-6 space-y-6",
            children: [
...
_s(CreateTaskPage, "qZYQv1tMxoRnqTZ5ooDI7zwfRkY=", false, function() {
    return [
...
//# sourceMappingURL=_9826b0b8._.js.map