...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        e.preventDefault();
        try {
            const res = await fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], "/api/auth/login"), {
                method: "POST",
                headers: {
...
//# sourceMappingURL=_ad658957._.js.map